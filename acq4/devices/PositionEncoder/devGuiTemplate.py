...
class Ui_encoderDevGui(object):
    def setupUi(self, encoderDevGui):
        ...
        self.resetCounterBtn = QtGui.QPushButton(encoderDevGui)
        self.resetCounterBtn.setObjectName(_fromUtf8("resetCounterBtn"))
        self.gridLayout.addWidget(self.resetCounterBtn, 2, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.counterLabel, 4, 2, 1, 2)
    ...
    def retranslateUi(self, encoderDevGui):
        ...
        self.resetCounterBtn.setText(_translate("encoderDevGui", "Reset Distance Counter", None))
